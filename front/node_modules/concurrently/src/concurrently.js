...
const ExpandNpmShortcut = require('concurrently/src/command-parser/expand-npm-shortcut');
const ExpandNpmWildcard = require('concurrently/src/command-parser/expand-npm-wildcard');

const CompletionListener = require('concurrently/src/completion-listener');

const getSpawnOpts = require('concurrently/src/get-spawn-opts');
const Command = require('concurrently/src/command');
